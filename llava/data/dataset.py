...
def apply_chat_template_no_length_warning(tokenizer, messages):
    try:
        return tokenizer.apply_chat_template(messages, verbose=False)
...
def preprocess_qwen(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False, max_len=2048, system_message: str = "You are a helpful assistant.") -> Dict:
    ...
    for i, source in enumerate(sources):
        ...
        input_id += apply_chat_template_no_length_warning(tokenizer, [{"role" : "system", "content" : system_message}])
        ...
        for conv in source:
            ...
            encode_id = apply_chat_template_no_length_warning(tokenizer, conv)
            input_id += encode_id
